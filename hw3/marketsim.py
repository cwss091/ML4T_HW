...
def _cash_value(trading_mat, ini_cv, close):
	...
	#print cv.ix[0], print cv.ix[1], print cv.ix[2]
	return cv
...
def main():
	...
	trade_matrix = _trade_mat_generate("orders.csv", timestamps, symbols, close_price)
	#print trade_matrix
	...
	_csv_write_timevalue(portfolio_value, "Value_timeseries_1.csv")
