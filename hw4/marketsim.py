...
def main():
	symbols, dates = _csv_read_sym_dates("myorders_10.csv")
	#print dates
	close_price, timestamps = _get_data(symbols, dates)
	#print close_price.ix[0], close_price.ix[1], close_price.ix[2]
	trade_matrix = _trade_mat_generate("myorders_10.csv", timestamps, symbols, close_price)
	#print trade_matrix
	...
	_csv_write_timevalue(portfolio_value, "Value_timeseries_10.csv")
